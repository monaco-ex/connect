...
this.TrezorConnect = (function () {
    ...
    var POPUP_URL = window.TREZOR_POPUP_URL || 'https://monaco-ex.github.io/connect/popup/popup.html';
    var POPUP_PATH = window.TREZOR_POPUP_PATH || 'https://monaco-ex.github.io/connect';
    ...
    function TrezorConnect() {
         ...
         *
         */
        this.setCoinName = function (name, callback, requiredFirmware) {
            try {
                manager.sendWithChannel(_fwStrFix({
                    type: 'setcoinname',
                    coin_name: name
